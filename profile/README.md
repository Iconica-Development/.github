...
| firebase-web-cd.yml | 2.0.0 | [firebase-web-cd.yml](./workflow-templates/firebase-web-cd.yml) | This workflow runs a Flutter buid for web and deploys it to Firebase Hosting (on pull requests and pushes to master). Configuring this action is done through ```firebase init hosting:github``` |
...
| flutter_date_time_picker | 3.3.0 | 2023-08-17 | No | [code](https://github.com/Iconica-Development/flutter_date_time_picker) | [example](https://github.com/Iconica-Development/flutter_date_time_picker/tree/master/example) |  |
