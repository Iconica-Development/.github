...
| firebase-fastlane-cd | 1.0.0 | [firebase-fastlane-cd.yml](../workflow-templates/firebase-fastlane-cd.yml) | This workflow runs a Flutter build for android and ios with fastlane, Fastlane and firebase need to be configured in the repository. The build is automatically sent to firebase |
